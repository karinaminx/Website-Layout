  ...
  .init({
    ...
    resources: {
      de: {
        ...
        hover5_1_methoden: "Dieses Ensemble berechnet sich als der quantilsweise Median der eingereichten Modelle mit vollständigen Nowcasts (28 bis 0 Tage vor dem aktuellen Datum).",
      ...
      en: {
        ...
        hover5_1_methoden: "This ensemble is calculated as the quantile median of the submitted models with full nowcasts (28 to 0 days before the current date).",
        ...
        yAxis: "7-day hospitalization incidence",
        xAxis: "Reporting date",
