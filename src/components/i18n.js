  ...
  .init({
    ...
    resources: {
      ...
      en: {
        ...
        button1_nowcast: "7-day hospitalization incidence",
        button1hover_nowcast: "Number of hospitalized COVID-19 cases per 100,000 population whose reporting date is within the last 7 days.",
        button2_nowcast: "7-day case numbers",
        button2hover_nowcast: "Number of new cases reported in the last 7 days.",
        button3_nowcast: "New case numbers",
        button3hover_nowcast: "Number of new cases reported in the last 24 hours.",
